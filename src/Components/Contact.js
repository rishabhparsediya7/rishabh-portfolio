            ...
            <form>
              <div className="mb-5">
                <input
                  ...
                  autoComplete="false"
                  className="w-full px-4 py-3 border-2 placeholder:text-black text-black rounded-md outline-none focus:ring-4 border-black ring-neutral-100 dark:border-neutral-600 focus:border-black dark:ring-0"
                  name="name"
                />
              </div>
              <div className="mb-5">
              ...
              <button
                type="submit"
                className="w-full py-4 font-semibold text-white transition-colors bg-neutral-900 rounded-md focus:outline-none focus:ring-offset-2 focus:ring focus:ring-white px-7"
              >
                Send Message
              </button>
            </form>
